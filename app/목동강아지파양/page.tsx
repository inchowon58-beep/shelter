...
export const metadata: Metadata = {
  title: "목동강아지파양, 아가펫스토리에서 책임감 있는 새 가족 찾아주기",
  description: "사랑하는 반려견에게 새로운 삶을 선물하세요. 목동강아지파양, 고민이 많으실 때 아가펫스토리에서 전문가의 도움으로 신중하고 책임감 있는 절차를 안내해 드립니다.",
  keywords: ["목동강아지파양", "강아지재입양", "목동반려견위탁", "목동강아지새가족", "목동펫상담"],
  ...
  openGraph: {
    ...
    images: [{ url: "https://shelter.agapet.co.kr/images/landing/목동강아지파양/아가펫강아지보호소 (45).png" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "목동강아지파양, 아가펫스토리에서 책임감 있는 새 가족 찾아주기",
    description: "사랑하는 반려견에게 새로운 삶을 선물하세요. 목동강아지파양, 고민이 많으실 때 아가펫스토리에서 전문가의 도움으로 신중하고 책임감 있는 절차를 안내해 드립니다.",
    images: ["https://shelter.agapet.co.kr/images/landing/목동강아지파양/아가펫강아지보호소 (45).png"],
  },
};
...
const jsonLd = {
  ...
  "@type": "WebPage",
  "name": "목동강아지파양, 아가펫스토리에서 책임감 있는 새 가족 찾아주기",
  "description": "사랑하는 반려견에게 새로운 삶을 선물하세요. 목동강아지파양, 고민이 많으실 때 아가펫스토리에서 전문가의 도움으로 신중하고 책임감 있는 절차를 안내해 드립니다.",
  "url": "https://shelter.agapet.co.kr/%EB%AA%A9%EB%8F%99%EA%B0%95%EC%95%84%EC%A7%80%ED%8C%8C%EC%96%91",
  "inLanguage": "ko-KR",
  "isPartOf": {
      ...
      <div className="landing-gimpo lp-root has-sticky-bar">
        <header className="lp-header">
          <div className="lp-header-inner">
            ...
            <nav className="lp-nav" aria-label="페이지 메뉴"><a href="#lp-about">"책임감 있는 재입양 안내"</a><a href="#lp-points">"아가펫스토리만의 강점"</a><a href="#lp-gallery">"성공적인 새 출발"</a><a href="#lp-reviews">"진솔한 후기"</a><a href="#lp-faq">"자주 묻는 질문"</a></nav>
        ...
        <section className="lp-hero" id="lp-hero">
          ...
          <div className="lp-hero-content">
            ...
            <h1>"목동강아지파양, 현명한 선택을 위한 아가펫스토리"</h1>
            <p className="lp-hero-lead">"사랑하는 가족에게 피치 못할 사정으로 이별을 고해야 할 때, 가슴 아픈 그 마음을 아가펫스토리가 헤아립니다. 목동의 소중한 반려견이 행복한 미래를 맞이하도록 책임감 있는 새로운 길을 열어드리겠습니다."</p>
        ...
        <section className="lp-section" id="lp-about">
          <div className="lp-container lp-about-grid">
            <div>
              ...
              <h2 className="lp-section-title">"목동강아지파양, 신중한 결정과 책임"</h2>
              <p className="lp-section-desc">"사랑으로 키운 강아지를 파양해야 하는 상황은 누구에게나 힘든 일입니다. 아가펫스토리는 목동강아지파양을 고민하는 보호자님의 마음을 깊이 이해하며, 반려견의 행복을 최우선으로 생각합니다. 무책임한 방치가 아닌, 더 좋은 환경과 진심으로 사랑해 줄 새로운 가족을 찾아주는 책임감 있는 과정을 제공합니다. 전문가의 도움으로 신중하게 진행되는 안전한 재입양 절차를 경험해보세요."</p>
              <div className="lp-nearby"><strong>인근 지역</strong><div className="lp-nearby-tags"><span className="lp-nearby-tag">"오목교"</span><span className="lp-nearby-tag">"등촌동"</span><span className="lp-nearby-tag">"염창동"</span></div></div>
            </div>
            <div><img className="lp-about-image" src="/images/landing/목동강아지파양/아가펫강아지보호소 (17).png" alt="목동강아지파양" loading="lazy" /></div>
          </div>
        </section>
        ...
        <section className="lp-section lp-section-alt" id="lp-points">
          <div className="lp-container">
            ...
            <h2 className="lp-section-title">"목동강아지파양, 아가펫스토리의 특별함"</h2>
            <div className="lp-features">
          <article className="lp-feature-card">
            <img className="lp-feature-img" src="/images/landing/목동강아지파양/아가펫강아지보호소 (23).png" alt="목동강아지파양 1" loading="lazy" />
            <div className="lp-feature-body">
              <p className="lp-feature-num">01</p>
              <h3>"목동 반려견의 개별 특성을 존중한 맞춤형 상담"</h3>
            </div>
          </article>
          <article className="lp-feature-card">
            <img className="lp-feature-img" src="/images/landing/목동강아지파양/아가펫강아지보호소 (13).png" alt="목동강아지파양 2" loading="lazy" />
            <div className="lp-feature-body">
              <p className="lp-feature-num">02</p>
              <h3>"새로운 가족을 위한 깐깐하고 투명한 심사 절차"</h3>
            </div>
          </article>
          <article className="lp-feature-card">
            <img className="lp-feature-img" src="/images/landing/목동강아지파양/아가펫강아지보호소 (26).png" alt="목동강아지파양 3" loading="lazy" />
            <div className="lp-feature-body">
              <p className="lp-feature-num">03</p>
              <h3>"강아지의 안전과 행복을 최우선으로 하는 전문성"</h3>
            </div>
          </article>
            </div>
          </div>
        ...
        <section className="lp-section" id="lp-gallery">
          <div className="lp-container">
            ...
            <h2 className="lp-section-title">"책임 있는 목동강아지파양의 여정"</h2>
            <div className="lp-gallery-grid">
            <div className="lp-gallery-item"><img src="/images/landing/목동강아지파양/아가펫강아지보호소 (46).jpg" alt="목동강아지파양" loading="lazy" /></div>
            <div className="lp-gallery-item"><img src="/images/landing/목동강아지파양/아가펫강아지보호소 (43).png" alt="목동강아지파양" loading="lazy" /></div>
            <div className="lp-gallery-item"><img src="/images/landing/목동강아지파양/아가펫강아지보호소 (44).png" alt="목동강아지파양" loading="lazy" /></div>
            <div className="lp-gallery-item"><img src="/images/landing/목동강아지파양/아가펫강아지보호소 (29).png" alt="목동강아지파양" loading="lazy" /></div>
            <div className="lp-gallery-item"><img src="/images/landing/목동강아지파양/아가펫강아지보호소 (39).jpg" alt="목동강아지파양" loading="lazy" /></div>
            </div>
          </div>
        </section>
        ...
        <section className="lp-section lp-section-alt" id="lp-reviews">
          <div className="lp-container">
            ...
            <h2 className="lp-section-title">"진심 담긴 목동강아지파양 후기"</h2>
            <div className="lp-reviews-grid">
          <blockquote className="lp-review-card">
            <p>"목동에서 반려견 파양 문제로 정말 막막했습니다. 아가펫스토리에 상담 후 걱정을 덜 수 있었어요. 전문가의 조언과 체계적인 절차 덕분에 저희 강아지가 좋은 가족을 만날 수 있었습니다. 진심으로 감사합니다."</p>
            <footer>"김OO"<span>"목동강아지파양"</span></footer>
          </blockquote>
          <blockquote className="lp-review-card">
            <p>"갑작스러운 해외 이주로 목동에서 키우던 반려견을 보낼 수밖에 없는 상황이었어요. 아가펫스토리는 강아지에게 가장 적합한 환경을 찾아주기 위해 꼼꼼하게 노력해주셨고, 덕분에 마음 놓고 떠날 수 있었습니다."</p>
            <footer>"박OO"<span>"목동 거주 반려인"</span></footer>
          </blockquote>
          <blockquote className="lp-review-card">
            <p>"혹시나 하는 마음에 목동강아지파양을 검색하다 아가펫스토리를 알게 됐어요. 단순한 파양이 아니라 새로운 행복을 찾아주는 과정이라는 설명에 감동받았습니다. 저희 강아지가 새 가족과 행복하게 지내는 모습에 눈물이 났습니다."</p>
        ...
        <section className="lp-section" id="lp-faq">
          <div className="lp-container">
            ...
            <h2 className="lp-section-title">"목동강아지파양, 궁금증 해결"</h2>
            <div className="lp-faq-list">
          <div className="lp-faq-item">
            <h3>"목동강아지파양, 어떤 절차로 진행되나요?"</h3>
            <p>"아가펫스토리는 반려견의 건강 상태와 성격 등을 먼저 상담하고, 새로운 보호자를 신중하게 탐색합니다. 이후 양측이 동의하면 서류 작성 및 인수인계 과정을 거쳐 안전하게 재입양을 완료합니다."</p>
          </div>
          <div className="lp-faq-item">
            <h3>"재입양 시 비용이 발생하나요?"</h3>
            <p>"책임감 있는 재입양 과정에는 상담, 심사, 서류 작업 등 여러 절차가 포함되며, 이에 따른 소정의 수수료가 발생할 수 있습니다. 자세한 내용은 상담을 통해 안내해 드립니다."</p>
          </div>
          <div className="lp-faq-item">
            <h3>"파양 후에도 반려견의 소식을 알 수 있나요?"</h3>
            <p>"가능합니다. 새로운 보호자의 동의하에 반려견이 새 가정에서 잘 지내고 있는지 소식을 전달받을 수 있도록 최선을 다합니다. 이는 보호자님의 마음을 조금이나마 위로해 드릴 수 있는 중요한 과정이라 생각합니다."</p>
          </div>
            </div>
          </div>
        </section>
