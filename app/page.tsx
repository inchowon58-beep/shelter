...
const processSteps = [
  {
    ...
    title: "전화 상담",
    description:
      "부산강아지파양·부산강아지보호소 상담 전화(0505-707-0401)로 연락 주세요. 반려견의 나이, 성격, 파양 사유를 비밀 보장 하에 편안하게 상담해 드립니다.",
  },
  {
    step: "2",
    title: "맞춤 절차 안내",
    description:
      "부산유기견보호소·부산유기견보호센터 연계 방법을 보호자님 상황에 맞게 설명합니다. 서두르지 않고 반려견에게 가장 나은 길을 함께 고릅니다.",
  },
  {
    step: "3",
    title: "보호소 입소",
    description:
      "부산유기견센터 연계 보호소에 입소하면 정서 안정과 일상 케어가 시작됩니다. 유기동물보호소 기준에 맞는 편안한 공간에서 반려견을 보호합니다.",
  },
  {
    step: "4",
    title: "입양·무료분양 연계",
    description:
      "준비가 되면 책임 있는 가정에 강아지무료분양을 연계합니다. 부산강아지파양 이후에도 입양 가정과의 안부 확인을 이어갑니다.",
  },
];
...
const serviceItems = [
  {
    title: "부산강아지파양 상담",
    text: "갑작스러운 상황으로 반려견을 맡기셔야 할 때, 부산강아지파양 전문 상담으로 차분하고 따뜻한 절차를 안내해 드립니다.",
  },
  {
    title: "부산강아지보호소·부산유기견보호소 연계",
    text: "부산강아지보호소 및 부산유기견보호소와 협력하여 반려견이 보호소에서도 안심할 수 있는 환경을 마련합니다.",
  },
  {
    title: "부산유기견센터·부산유기견보호센터 안내",
    text: "부산유기견센터 등록부터 부산유기견보호센터 입소, 필요한 관리까지 단계별로 상세하게 안내합니다.",
  },
  {
...
const promises = [
  {
    num: "01",
    title: "정성껏 돌봅니다",
    text: "부산강아지파양·부산강아지보호소 상담은 보호자님의 마음을 먼저 헤아립니다. 반려견과 사람 모두를 위한 방법을 함께 찾습니다.",
  },
  {
    num: "02",
    title: "끝까지 책임집니다",
    text: "부산유기견보호센터 입소 이후에도 일상 케어, 강아지무료분양 입양 연계, 사후 안부 확인까지 꾸준히 지원합니다.",
  },
  {
    num: "03",
    title: "편하게 물어보세요",
    text: "부산유기견보호소 보호 과정과 비용을 명확히 알려 드립니다. 유기동물보호소 기준에 맞는 투명한 운영이 신뢰의 시작입니다.",
  },
];

const faqItems = [
  {
    question: "부산강아지파양은 어떤 경우에 이용하나요?",
    answer:
      "이사, 알레르기, 경제적 사정, 가족 구성 변화 등 부득이한 사유로 직접 돌보기 어려울 때 이용하실 수 있습니다. 부산강아지보호소·부산유기견보호소 상담을 통해 임시 보호, 가족 위탁 등 다른 선택지도 함께 안내해 드립니다.",
  },
  {
    question: "부산유기견센터와 부산유기견보호센터는 어떻게 다른가요?",
    answer:
      "부산유기견센터는 유기견 행정·관리 기관이며, 부산유기견보호센터는 실제 보호와 케어가 이루어지는 시설입니다. 본 상담센터는 두 기관과 연계해 파양·보호·입양 절차를 안내합니다.",
  },
  {
  ...
  {
    question: "부산 지역 외에서도 파양이 가능한가요?",
    answer:
      "주로 부산 및 경남 인근 지역을 대상으로 운영하고 있으나, 상황에 따라 방문 상담이 가능합니다. 부산유기견보호소 입소 전 먼저 전화 상담을 통해 거주 지역과 반려견 정보를 알려 주세요.",
  },
  {
    question: "유기동물보호소 이용 시 비용이 발생하나요?",
    answer:
      "보호소 운영비, 건강 관리비, 사료·의료비 등 실비가 발생할 수 있습니다. 부산강아지파양·부산강아지보호소 상담 시 투명하게 안내해 드리며, 어려우신 경우에도 최대한 도움을 드리고 있습니다.",
  },
  {
    question: "입양 후에도 연락이 가능한가요?",
    answer:
      "네, 입양 가정과의 사후 관리를 위해 정기적인 안부 확인을 진행합니다. 부산강아지파양·강아지무료분양을 통해 보호된 반려견이 새 가정에서 잘 지낼 수 있도록 지속적으로 지원합니다.",
  },
];
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-8 lg:grid-cols-2 lg:py-28">
            <div>
              ...
              <p className="mt-2 font-serif text-lg text-aga-brown sm:text-xl">
                부산유기견보호소 · 반려견을 위한 진심 어린 안내
              </p>
              <p className="mt-6 max-w-lg text-sm leading-relaxed text-warm sm:text-base">
                부산강아지파양·부산강아지보호소·부산유기견보호소 전문
                상담센터입니다. 부산유기견센터·부산유기견보호센터와
        ...
        >
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-8">
            ...
            <p className="mx-auto mt-8 max-w-xl text-sm leading-relaxed text-warm sm:text-base">
              부산강아지파양은 반려견 입양뿐 아니라 불가피한 파양을
              고민하는 보호자에게도 문을 엽니다. 부산유기견보호소·
            ...
            <div className="grid gap-16 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-6 text-sm leading-relaxed text-warm sm:text-base">
                  부산강아지파양부터 부산유기견센터·부산유기견보호센터
                  연계, 강아지무료분양·유기동물보호소 입양까지 부산 지역
                  반려견 보호 전 과정을 안내합니다.
                </p>
              </div>
        ...
        >
          <div className="mx-auto max-w-6xl px-4 sm:px-8">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-warm sm:text-base">
              부산유기견보호소·유기동물보호소 기준에 맞춰 반려견이 안전하고
      ...
      <footer className="border-t border-charcoal/10 bg-aga-dark py-12 text-cream">
        <div className="mx-auto max-w-6xl px-4 sm:px-8">
          ...
          <p className="mt-6 text-center text-[10px] leading-relaxed text-warm-light/70">
            부산강아지파양 · 부산강아지보호소 · 부산유기견보호소 ·
            부산유기견센터 · 부산유기견보호센터 · 강아지무료분양 ·
            유기동물보호소
          </p>
          <p className="mt-3 text-center text-[10px] text-warm-light/50">
            © {new Date().getFullYear()} 아가펫보호소 · 부산강아지파양 안내
          </p>
        </div>
      </footer>
